    ...
    <div class="lower">
        ...
        <div class="right">
                <?php if (!empty($facebook_url)) : ?>
                    <a target="_blank" class="link" href="<?php echo esc_url($facebook_url); ?>" aria-label="Lien vers Facebook">
                        <i class="fa-brands fa-facebook-f"></i>
                    </a>
                <?php endif; ?>
                
                <?php if (!empty($instagram_url)) : ?>
                    <a target="_blank" class="link" href="<?php echo esc_url($instagram_url); ?>" aria-label="Lien vers Instagram">
                        <i class="fa-brands fa-instagram"></i>
                    </a>
                <?php endif; ?>
                
                <?php if (!empty($linkedin_url)) : ?>
                    <a target="_blank" class="link" href="<?php echo esc_url($linkedin_url); ?>" aria-label="Lien vers LinkedIn">
                        <i class="fa-brands fa-linkedin"></i>
                    </a>
                <?php endif; ?>
                
                <?php if (!empty($youtube_url)) : ?>
                    <a target="_blank" class="link" href="<?php echo esc_url($youtube_url); ?>" aria-label="Lien vers YouTube">
